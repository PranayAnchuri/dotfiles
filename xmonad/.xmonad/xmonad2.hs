...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm,               xK_p     ), spawn "~/bin/dotbin/bin/centerlaunch")
    ...
    -- My Stuff
    , ((modm,               xK_b     ), spawn "exec ~/bin/dotbin/bin/bartoggle")
    --, ((modm,               xK_z     ), spawn "exec ~/bin/dotbin/bin/inhibit_activate")
    , ((modm .|. shiftMask, xK_z     ), spawn "exec ~/bin/dotbin/bin/inhibit_deactivate")
    , ((modm .|. shiftMask, xK_a     ), spawn "exec ~/bin/dotbin/bin/clipboardy")
    ...
    -- Quit xmonad
    , ((modm .|. shiftMask, xK_q     ), spawn "~/bin/dotbin/bin/powermenu.sh")
    -- run programs
    , ((mod4Mask, xK_p), spawn "rofi -show run")
    -- tree select workspaces
    , ((modm, xK_f), treeselectWorkspace myTreeConf myWorkspaces W.view) -- can change to view or greedy view
